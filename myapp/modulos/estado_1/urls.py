...
urlpatterns = patterns('myapp.modulos.estado_1.views', 
	...
	url(r'^comentarMedia/(?P<id_media>.*)/(?P<id_ssp>.*)/$', 'comentar_media_view'),
	url(r'^etiquetarMedia/(?P<id_media>.*)/$', 'etiquetar_media_view'),
	url(r'^crearEtiqueta/(?P<id_ssp>.*)/$', 'crear_etiqueta_view'),
	url(r'^eliminarEtiquetaMedia/(?P<id_ssp>.*)/(?P<id_media>.*)/(?P<id_tag>.*)/$', 'eliminar_etiqueta_media_view'),
    ...
    url(r'^newDocumento/(?P<id_ssp>.*)/(?P<id_analisis>.*)/$', 'analisis_newDocumento_view'),
    url(r'^eliminarDocumento/(?P<id_ssp>.*)/(?P<id_analisis>.*)/(?P<id_documento>.*)/$', 'analisis_eliminarDocumento_view'),
	url(r'^eliminarEtiquetaAnalisis/(?P<id_ssp>.*)/(?P<id_analisis>.*)/(?P<id_tag>.*)/$', 'eliminar_etiqueta_analisis_view'),
